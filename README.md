...
Per impostare una variabile singola dal terminale Codex (con link automatico al progetto):

```bash
bash scripts/railway_variables_set.sh NOME_VARIABILE valore
# opzionale: deploy immediato
APPLY_DEPLOY=1 bash scripts/railway_variables_set.sh NOME_VARIABILE valore
```
